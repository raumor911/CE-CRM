          ...
          */}
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 p-8 rounded-2xl space-y-6">
            <div className="flex items-center gap-3 border-b border-zinc-800 pb-4">
              ...
              <h3 className="text-lg font-bold text-white">Administración de Usuarios</h3>
            </div>
            <div className="space-y-4">
              <p className="text-sm text-zinc-400">
                La gestión de cuentas y provisionamiento de accesos ha sido migrada a un entorno seguro del servidor por políticas de seguridad. Contacta a tu administrador de sistemas para altas de nuevos usuarios o cambios de contraseña.
              </p>
              <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl flex items-center gap-3">
                <Shield className="text-amber-500 shrink-0" size={20} />
                <p className="text-xs text-amber-500 font-medium">
                  Se requiere nivel de acceso "Administrador Global" para interactuar con el módulo de identidades (IAM).
                </p>
              </div>
            </div>
          </div>
