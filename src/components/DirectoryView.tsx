  ...
  return (
    <div className="p-6 space-y-6 bg-bg-main min-h-full">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black tracking-tight text-slate-900">Directorio de Leads</h1>
          <p className="text-slate-500 text-sm font-medium">Gestión masiva y búsqueda detallada de prospectos.</p>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-100 bg-slate-50/50">
                ...
                <th className="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-wider">Etapa</th>
