    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4 font-sans selection:bg-indigo-500/30 selection:text-indigo-200">
      ...
      >
        <div className="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="mt-8 pt-4 border-t border-zinc-800 flex flex-col items-center">
            <p className="text-[9px] text-zinc-600 uppercase tracking-widest font-bold">Catalyst CRM • Creativos Espacios</p>
            <p className="text-[9px] text-zinc-600 mt-1">Sales Cockpit v{BrandConfig.Version} • ISO 27001 Compliant</p>
          </div>
        </div>
      </motion.div>
    </div>
